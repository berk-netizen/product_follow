    ...
    return (
        ...
        >
            <Card className={cn(
                ...
                <div className="group/image relative w-full h-36 overflow-hidden border-b border-border/50 bg-muted/30 flex flex-col items-center justify-center">
                    {displayImage ? (
                        <Image
                            src={displayImage}
                            alt={item.model_name}
                        ...
                        <div className="flex flex-col items-center justify-center text-muted-foreground/30">
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-wider opacity-20 italic">No Image</span>
                        </div>
                    )}
